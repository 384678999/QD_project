                ...
                <el-col :span="18">
                  <el-form-item label="所属分类" prop="article_cate_id">
                    <el-select v-model="formData.article_cate_id" placeholder="请选择所属分类">
                      <el-option
                        v-for="item in article_cate_list"
                        :key="item.id"
                        :label="item.title"
                        :value="item.id"
                      ></el-option>
              ...
              <el-col :span="24" style="height:200px;">
                <el-form-item label="缩略图">
                  ...
                  >
                    ...
                    <img
                      v-if="imageUrl=='' && formData.pic"
                      :src="$url+'uploads/'+formData.pic"
                      class="avatar"
                    />
                    <i
                      v-if="imageUrl=='' && formData.pic==undefined"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        order: [{ type: "number", message: "必须为数字值" }],
        article_cate_id: [
